...
return [
    ...
    'apps' =>[
        'apps' => 'Applications',
        'create-an-app' => 'Create an application',
        'create-wordpress' => 'Install on WordPress or WooCommerce',
    ...
    'integration' => [
        ...
        'confirm' => 'Your website is already configured',
        'confirm-question' => 'Do you want to adapt it for use with :platform?',
        'alerts' => [
